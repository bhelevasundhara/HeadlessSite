...
export const metadata: Metadata = {
  title: "Bobcat Heavy Equipment | Find the Right Machine",
  description: "Search Bobcat heavy equipment products. Compact loaders, excavators, telehandlers and more.",
};
        ...
        <header className="bg-[#1a1f2e] text-white sticky top-0 z-50 shadow-lg">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-9 h-9 bg-[#e63329] rounded-sm flex items-center justify-center font-black text-white text-sm">B</div>
              <span className="font-bold text-lg tracking-tight">Bobcat Heavy Equipment</span>
            </Link>
